...
const StudentRepSignup = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:4000/api/studentRep/create', formData);
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h2>Student Representative Signup</h2>
...
export default StudentRepSignup;
